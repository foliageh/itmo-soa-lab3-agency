...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema agencySchema) {
        ...
        wsdl11Definition.setTargetNamespace("http://example.com/agency/schemas");
        wsdl11Definition.setSchema(agencySchema);
        return wsdl11Definition;
    }
    
    @Bean
    public XsdSchema agencySchema() {
        return new SimpleXsdSchema(new ClassPathResource("xsd/agency.xsd"));
    }
}
